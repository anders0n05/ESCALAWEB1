...
class EstoqueArmazemModel {
    ...
    protected $nrSerie;
    protected $nrDocumento;
    protected $nrPedido;
    protected $unitizacao;
    protected $endereco;
    protected $unidade;
    ...
    public function getQuery($filtro = '') {
        return "SELECT B0.CODIGOREFERENCIA CODIGOREFERENCIA, 
                       B0.NOME PRODUTO,
                       B7.LOTEPESQUISA  LOTE,
                       B7.VALIDADE VALIDADE,
                       B7.FABRICACAO FABRICACAO,
                       B7.IDENTIFICACAO NRSERIE,
                       B14.NUMERODOCUMENTO NRDOCUMENTO,
                       B14.NUMEROPEDIDO NRPEDIDO, 
                  ...
                  LEFT JOIN AM_DEPOSITOLOCALIZACAO (NOLOCK) B2 ON A.ENDERECO = B2.HANDLE 
    ...
    public function getUnitizacao(){
        return $this->unitizacao;
    }
    ...
    protected function setFabricacao($fabricacao) {
        $this->fabricacao = $fabricacao;
    }

    protected function setNrSerie($nrSerie){
        $this->nrSerie = $nrSerie;
    }

    protected function setNrDocumento($nrDocumento){
        $this->nrDocumento = $nrDocumento;
    }

    protected function setUnitizacao($unitizacao){
